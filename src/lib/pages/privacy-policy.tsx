...
const PrivacyPolicyPage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Privacy Policy - IconicMe | Image Stylizer</title>
        <meta name="description" content="Privacy Policy for IconicMe - Image Stylizer by Pixelspulse Private Limited" />
